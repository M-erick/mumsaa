                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <form action="{{ route('list') }}" method="POST">
                        ...
                        <div class="  flex  justify-between items-center  w-full  py-5  border-b-2 border-gray-200 ">
                            ...
                            <input type="text" class="text-black mr-4 outline-none" name="admission"
                                placeholder="CCS/00123/019" autocomplete="off">
                        ...
                        <div class="  flex  justify-between items-center  w-full  py-5  border-b-2 border-gray-200 ">
                            ...
                            {{-- <p class="text-black mr-4">$2,650</p> --}}
                            <input type="text" class="text-black mr-4 outline-none" name="name" placeholder="jame"
                                autocomplete="off">
                        ...
                        <div class="  flex  justify-between items-center  w-full  py-5  border-b-2 border-gray-200 ">
                            ...
                            {{-- <p class="text-gray-400 ml-4">Days</p> --}}
                            <label for="payment" class="text-gray-400 ml-4  ">Payment:</label>
                            {{-- <p class="text-black mr-4">$2,650</p> --}}
                            <select id="payment" name="payment" autocomplete="off"
                                ...
                                <option class="mt-2"> Registration fees</option>
                                <option class="mt-2"> Contributions</option>
                                <option class="mt-2"> SemesterPartyContribution</option>
                            </select>
                        ...
                        <div class="   flex justify-between items-center   w-full py-5 border-b-2 border-gray-200 ">
                            ...
                            <input type="text" class="text-black mr-4 outline-none" name="amount" autocomplete="off"
                                placeholder="1200">
