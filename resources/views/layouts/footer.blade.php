...
<div class="w-full min-h-full flex items-center justify-center bg-gray-900">
    <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div class="flex flex-col">
            <div class="flex mt-10 mb-4 flex-row justify-between">
                <div class="">
                 <span>Auction</span>
                </div>
                <a class="
                    hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About</a>
                ...
                {{-- below current year should be dynamic --}}
                <p class="w-full text-center my-12 text-gray-600">Copyright © {{ date('Y') }} Auction</p>
            </div>
        </div>
    </div>
