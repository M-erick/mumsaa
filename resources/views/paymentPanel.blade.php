            ...
            <div class="container bg-white  w-full border-b  border-gray-300 ">
                ...
                @if (session()->has('message'))
                    <div class="w-full m-auto mt-10 p-auto">
                        <p class="w-full mb-4 text-gray-50 bg-gray-500 rounded-2xl py-4 px-3">
                            {{ session()->get('message') }}
                    ...
                    <div class="w-4/5 self-center m-auto p-6">
                        <ul>
                            @foreach ($errors->all() as $error)
                                <li class="w-full mb-4 text-gray-50 bg-red-700 rounded-2xl py-4 px-3">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <span
                                                        ...
                                                        <span class="relative text-xs">{{ $data->payment}}</span>
                                                    </span>
                                                </td>
                                                <td
